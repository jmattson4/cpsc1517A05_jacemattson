        ...
        <tr>
            <td align="center">
                <asp:GridView ID="CategoryProductList" runat="server"
                    AllowPaging="True" PageSize="5" PagerSettings-FirstPageText="Start"
                    PagerSettings-LastPageText="End" AlternatingRowStyle-BackColor="#CCCCCC" 
                    OnPageIndexChanging="CategoryProductList_PageIndexChanging" 
                    AutoGenerateColumns="False" OnSelectedIndexChanged="CategoryProductList_SelectedIndexChanged">
                    <AlternatingRowStyle BackColor="#CCCCCC"></AlternatingRowStyle>

                    <Columns>
                        <asp:CommandField CausesValidation="False" SelectText="View" ShowSelectButton="True" HeaderStyle-BackColor="#999999" />
