...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:GridView ID="ProductList" runat="server"
            ...
            DataSourceID="ProductCategoryODS" AllowPaging="True">
              <Columns>
...
<%--                       <asp:Label ID="SupplierID" runat="server" 
                        ...
                        <asp:DropDownList ID="SupplierList" runat="server" DataSourceID="SupplierListODS" 
                            ...
                            selectedvalue='<%# Eval("SupplierID") %>' Enabled="false"></asp:DropDownList>
                    </ItemTemplate>
...
<%--                         <asp:Label ID="CategoryID" runat="server" 
                        ...
                        <asp:DropDownList ID="CategoryListGV" runat="server" DataSourceID="CategoryListODS" 
                            ...
                            selectedvalue='<%# Eval("CategoryID") %>' Enabled="false"></asp:DropDownList>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="CategoryListODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="Category_List" 
        TypeName="NorthwindSystem.BLL.CategoryController">
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="SupplierListODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" 
        SelectMethod="Supplier_List" TypeName="NorthwindSystem.BLL.SupplierController">
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="ProductCategoryODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="Product_GetByCategory" 
