...
namespace NorthwindSystem.Data
{
    ...
    public class Product
    {
        ...
        [Key]//[Key, DatabaseGenerated(DatabaseGeneratedOption.Identity)] if the database will generate
        ...
        [StringLength(20, ErrorMessage ="Quantity cannot be higher than 20 characters.")]
